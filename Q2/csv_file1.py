...
#use pandas read_csv() function to display file1.csv 
#when the users clicks on the file from the webpage
csvdata = pandas.read_csv("file1.csv")
htmldata = csvdata.to_html()

#use the os.path library and abspath method to generate html file,  
#to be displayed and combine its full path in a url
path = os.path.abspath('csv_file1.html')
url = 'file://' + path
